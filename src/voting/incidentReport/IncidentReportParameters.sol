...
abstract contract IncidentReportParameters is VotingParameters {
    ...
    uint256 constant PENDING_PERIOD = 5 minutes;

    // 16 hours for fuji, 2 hours for fujiInternal
    uint256 constant INCIDENT_VOTING_PERIOD = 30 minutes;

    uint256 constant EXTEND_PERIOD = 10 minutes;
    uint256 constant SAMPLE_PERIOD = 10 minutes;
